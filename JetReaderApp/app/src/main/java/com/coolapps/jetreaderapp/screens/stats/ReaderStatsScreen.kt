package com.coolapps.jetreaderapp.screens.stats
...
import com.coolapps.jetreaderapp.components.ReaderAppBar
        ...
        Row(modifier = Modifier.padding(5.dp),
            ...
            Column {
               Row(horizontalArrangement = Arrangement.SpaceBetween) {
                ...
                Text(text = "Started: ${book.startedReading?.let { formatDate(it) }}",
                    softWrap = true,
                    overflow = TextOverflow.Clip,
                    fontStyle = FontStyle.Italic,
                    style = MaterialTheme.typography.caption)

                Text(text = "Finished: ${book.finishedReading?.let { formatDate(it) }}",
                    overflow = TextOverflow.Clip,
                    fontStyle = FontStyle.Italic,
                    style = MaterialTheme.typography.caption)
